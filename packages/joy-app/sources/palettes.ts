...
export const PALETTES: NamedPalette[] = [
    { id: 'solarized-light', name: 'Solarized Light', background: '#fdf6e3', surface: '#eee8d5', surfaceAlt: '#e8e1cb', text: '#586e75', textSecondary: '#657b83', accent: '#268bd2', border: '#d8d2bf', userBubble: '#eee8d5', accents: { blue: '#268bd2', indigo: '#6c71c4', green: '#859900', orange: '#cb4b16', red: '#dc322f', pink: '#d33682' } },
    ...
    { id: 'catppuccin-latte', name: 'Catppuccin Latte', background: '#eff1f5', surface: '#e6e9ef', surfaceAlt: '#ccd0da', text: '#4c4f69', textSecondary: '#6c6f85', accent: '#1e66f5', border: '#ccd0da', userBubble: '#e6e9ef', accents: { blue: '#1e66f5', indigo: '#8839ef', green: '#40a02b', orange: '#fe640b', red: '#d20f39', pink: '#ea76cb' } },
];
...
export const DARK_PALETTES: NamedPalette[] = [
    ...
    { id: 'material-deep-ocean', name: 'Material Deep Ocean', background: '#0f111a', surface: '#181a1f', surfaceAlt: '#1a1c25', text: '#eeffff', textSecondary: '#464b5d', accent: '#84ffff', border: '#1f2233', userBubble: '#222533', accents: { blue: '#82aaff', indigo: '#c792ea', green: '#c3e88d', orange: '#f78c6c', red: '#f07178', pink: '#f06292' } },
    ...
    { id: 'catppuccin-mocha', name: 'Catppuccin Mocha', background: '#1e1e2e', surface: '#313244', surfaceAlt: '#45475a', text: '#cdd6f4', textSecondary: '#a6adc8', accent: '#89b4fa', border: '#313244', userBubble: '#45475a', accents: { blue: '#89b4fa', indigo: '#cba6f7', green: '#a6e3a1', orange: '#fab387', red: '#f38ba8', pink: '#f5c2e7' } },
];
