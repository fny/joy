...
export function showMicrophonePermissionDeniedAlert(canAskAgain: boolean = false) {
  ...
  const message = canAskAgain
    ? 'Joy needs access to your microphone for voice chat. Please grant permission when prompted.'
    : 'Joy needs access to your microphone for voice chat. Please enable microphone access in your device settings.';
