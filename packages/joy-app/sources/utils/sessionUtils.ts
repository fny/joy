...
// Re-exported so every existing importer keeps working; it lives in
// statusPalette.ts because pure modules need it and cannot take this file's
// react-native import graph.
