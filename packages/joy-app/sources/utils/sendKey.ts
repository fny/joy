 ...
 *  is a new message, not a retry (Astra on 1bd9651f, #7). A failure that
 *  happened after this send began is untouched — two concurrent sends where
 *  one lost its ack must still be able to replay the other (Astra on 90874d21). */
