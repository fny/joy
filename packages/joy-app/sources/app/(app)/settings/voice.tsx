    ...
    return (
        <ItemList style={{ paddingTop: 0 }}>
            ...
            {devModeEnabled && (
                <ItemGroup
                    title="Developer"
                    footer="Developer-only diagnostics and local override controls for the current voice rollout. The paid voice gate runs through Joy server unless Direct Connection and a custom ElevenLabs agent are both enabled."
                >
                    <Item
