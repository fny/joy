...
describe('filesFromStructured', () => {
    ...
    it('two different non-UTF-8 names never collapse into one row; each is unaddressable (89c8d5a8 residual #3)', () => {
...
describe('mergeChangeRows', () => {
    ...
    it('a staged edit followed by a worktree deletion shows as deleted, not as an openable modified file (#216, 89c8d5a8 residual #4)', () => {
        const rows = mergeChangeRows(
...
describe('createRefreshScope', () => {
    ...
    it('retire is owner-specific: disposing screen A leaves screen B\'s newer refresh current (#316, 89c8d5a8 residual #5)', () => {
