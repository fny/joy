...
export const LocalSettingsSchema = z.object({
    ...
    fontOverride: z.string().nullable().describe('Override for the default UI font family (Appearance font switcher; null = IBM Plex Sans)'),
    monoOverride: z.string().nullable().describe('Override for the monospace font family (code/mono surfaces; null = IBM Plex Mono)'),
