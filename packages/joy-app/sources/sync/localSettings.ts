...
export const LocalSettingsSchema = z.object({
    ...
    nativeTextSelection: z.boolean().describe('iOS: render agent text in a UITextView so a phrase can be selected in place. Off falls back to RN Text, whose iOS long-press only offers copy-the-whole-block.'),
