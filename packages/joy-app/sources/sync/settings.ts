...
export const SettingsSchema = z.object({
    ...
    voiceCustomAgentId: z.string().nullable().describe('Custom ElevenLabs agent ID (null to use Joy default)'),
    voiceBypassToken: z.boolean().describe('Bypass Joy server token and connect directly to ElevenLabs (requires custom agent ID)'),
