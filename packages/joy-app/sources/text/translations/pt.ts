...
export const pt: TranslationStructure = {
    ...
    errors: {
        ...
        daemonOutdated: 'O daemon desta máquina está desatualizado — execute `joy update` nela',
        ...
        sessionFull: 'Esta sessão está cheia — continue em uma nova sessão',
        pairingCodeExpired: 'O código expirou — escaneie novamente',
        machineBusy: 'A máquina está ocupada — tente novamente em instantes',
        relayBusy: 'O relay está ocupado — tente novamente em instantes',
        ...
        spawnAlreadyOpen: 'Essa conversa já está aberta em outra sessão nesta máquina.',
        spawnDidNotStart: 'A sessão foi aceita, mas não iniciou a tempo. Verifique o daemon nessa máquina.',
        historyPageFailed: 'Não foi possível carregar as mensagens anteriores.',
    },
    ...
    newSession: {
        ...
        creationUncertainTitle: 'Sessão não confirmada',
        creationUncertainMessage: 'O relay não confirmou a nova sessão. Tentar novamente envia o mesmo pedido outra vez, então no máximo uma sessão será iniciada.',
    },
    ...
    drafts: {
        attachmentsMissing: ({ count, total }: { count: number; total: number }) => `Faltam ${count} de ${total} imagens`,
        attachmentsMissingTitle: 'Imagens em falta',
        attachmentsMissingBody: ({ count }: { count: number }) => `${count} imagens deste rascunho já não estão no armazenamento deste dispositivo. Enviar sem elas?`,
        sendWithout: 'Enviar sem elas',
    },
    joyDialog: {
    ...
    agentInput: {
        ...
        limits: {
            ...
            unavailable: 'Não foi possível ler a quota desta máquina.',
        },
        context: {
            used_short: ({ tokens }: { tokens: string }) => `${tokens} ctx`,
            windowUnknown: 'O tamanho da janela de contexto deste modelo é desconhecido, por isso nenhuma percentagem é mostrada.',
            title: 'CONTEXTO',
            used: 'Usado',
    ...
    sidebar: {
        ...
        hideAutomations: 'Ocultar automações',
        showHeadless: 'Mostrar headless',
        hideHeadless: 'Ocultar headless',
        sortByProject: 'por projeto',
    ...
    files: {
        ...
        newFileInProject: 'Dê um nome — um caminho como src/notes.md também funciona.',
        newFileInSession: 'Dê um nome. Ele vai para a pasta desta sessão.',
        newFilePlaceholder: 'notes.md',
        fileExists: ({ name }: { name: string }) => `${name} já existe.`,
        discardEdits: 'Descartar as alterações?',
        discardEditsMessage: 'Suas alterações neste arquivo serão perdidas.',
        sessionFiles: 'Arquivos da sessão',
        noSessionFiles: 'Ainda não há envios nem imagens. Arquivos anexados a uma mensagem ficam aqui, fora do projeto.',
        sessionFilesFooter: 'Arquivos que você enviou e imagens que o agente mostrou, guardados fora do projeto, na pasta da sessão na máquina dela.',
        ...
        diffSplit: 'Dividido',
        diffWholeFile: 'Arquivo completo',
        changes: 'Alterações',
        ...
        statusFailed: 'Não foi possível carregar as alterações',
        statusStale: 'Não foi possível atualizar as alterações — mostrando o último estado conhecido',
        diffStale: 'Não foi possível atualizar este diff — mostrando a última versão conhecida',
        ...
        conflicted: 'Conflito',
        refreshFailed: 'Não foi possível atualizar a partir da máquina; exibindo a última versão carregada.',
    },
    ...
    terminal: {
        ...
        pairingRequestNotFound: 'Nenhuma solicitação de conexão pendente foi encontrada para este link. Ele pode ter expirado ou pertencer a outro relay — gere um novo link no terminal e tente novamente.',
    },
    ...
    voice: {
        ...
        refusedTitle: 'Chamada de voz recusada',
        refusedMessage: ({ reason }: { reason: string }) => `O agente encerrou a chamada logo após conectar, antes de qualquer fala. ${reason}`,
        refusedOverrides: 'O modo "Em espera" substitui o prompt do sistema e a primeira mensagem, o que este agente não permite. Habilite ambos em Security no painel do ElevenLabs, ou mude Voz para "Sempre ligada".',
        refusedNoReason: 'Verifique o agente no painel do ElevenLabs.',
        end: 'Terminar voz',
    },
    settingsModels: {
        machine: 'Máquina',
        machineFooter: 'Os catálogos são lidos desta máquina; a escolha abaixo vale para todas as máquinas.',
        noMachines: 'Nenhuma máquina ainda',
        offline: 'offline',
        noPicker: 'Este agente não tem seletor de modelo nesta máquina.',
        loading: 'Carregando catálogo…',
        error: ({ error }: { error: string }) => `Não foi possível ler o catálogo: ${error}`,
        unavailable: 'Máquina inacessível',
        empty: 'Nenhum modelo',
        recommendedOnly: 'Somente recomendados',
        recommendedOnlySubtitle: 'Mostrar só a lista curta do daemon (padrão)',
        enableAll: 'Ativar todos',
        enabledCount: ({ enabled, total }: { enabled: number; total: number }) => `${enabled} de ${total} ativados`,
    ...
    settingsVoice: {
        ...
        modeTitle: 'Conversa',
        modeClassic: 'Sempre ligada',
        modeClassicSubtitle: 'Uma única conversa desde o toque no microfone até você encerrá-la. Não envia nada que o agente precise permitir, então um agente padrão funciona como está.',
        modeStandby: 'Em espera',
        modeStandbySubtitle: 'Desliga após o silêncio e acorda com eventos da sessão ou com a sua voz. Requer que o agente permita substituir o prompt do sistema e a primeira mensagem (aba Security).',
        ...
        setupFooter: 'No painel do ElevenLabs o agente precisa das client tools sendMessageToSession(sessionId, message) e processPermissionRequest(requestId, decision), e opcionalmente da ferramenta integrada skip_turn. O modo "Em espera" também precisa dos overrides habilitados para prompt do sistema e primeira mensagem (aba Security); "Sempre ligada" não precisa de nada.',
        setupPrompt: 'Prompt de sistema sugerido',
        setupPromptSubtitle: 'Toque para copiar e cole no prompt do agente no painel. No modo "Sempre ligada" as mesmas notas também são enviadas como contexto a cada conexão.',
    },
    machine: {
