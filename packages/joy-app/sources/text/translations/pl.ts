...
/**
 * Polish translations for the Joy app
...
export const pl: TranslationStructure = {
    ...
    status: {
        connected: 'połączono',
        machinesConnected: ({ online, total }: { online: number; total: number }) => `${online}/${total} połączono`,
        connecting: 'łączenie',
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Joy to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    errors: {
        ...
        sendFailedMessage: 'Nie udało się wysłać wiadomości. Została przywrócona do pola tekstowego, aby można było spróbować ponownie.',
    ...
    joyQueue: {
        ...
        pendingItem: ({ text }: { text: string }) => `w kolejce: ${text}`,
    ...
    sessionInfo: {
        ...
        resetChatState: 'Zresetuj stan czatu',
        resetChatStateSubtitle: 'Wyczyść lokalne dane czatu i pobierz je ponownie',
        resetChatStateWarning: 'Czyści lokalnie zapisane wiadomości tej sesji i ponownie pobiera rozmowę z serwera. Nic na serwerze ani na maszynie nie jest zmieniane.',
        metadata: 'Metadane',
        host: 'Host',
        path: 'Ścieżka',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Joy. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        renameMessage: ({ host }: { host: string }) => `Własna nazwa tej maszyny (puste — użyj hostname "${host}")`,
    ...
    imageUpload: {
        ...
        emptyFileMessage: ({ name }: { name: string }) => `„${name}” jest pusty i nie został wysłany.`,
