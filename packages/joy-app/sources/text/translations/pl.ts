...
export const pl: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        setupFooter: 'W panelu ElevenLabs agent potrzebuje: włączonych nadpisań promptu systemowego i pierwszej wiadomości (zakładka Security); narzędzi klienta sendMessageToSession(sessionId, message) i processPermissionRequest(requestId, decision); opcjonalnie wbudowanego narzędzia skip_turn.',
    },
    machine: {
