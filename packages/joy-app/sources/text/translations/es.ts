...
export const es: TranslationStructure = {
    ...
    settingsMods: {
        ...
        mod07Description: 'Muestra un botón «Abrir archivo» en las llamadas a la herramienta Read. El botón utiliza el visor de archivos integrado de Joy, que descarga desde el host de Claude — funciona tanto si la app y Claude están en la misma máquina como si no.',
    },
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de Joy copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Joy',
        happySessionId: 'ID de sesión de Joy',
