...
export const es: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        setupFooter: 'En el panel de ElevenLabs el agente necesita: overrides activados para el system prompt y el primer mensaje (pestaña Security); herramientas de cliente sendMessageToSession(sessionId, message) y processPermissionRequest(requestId, decision); opcionalmente la herramienta integrada skip_turn.',
    },
    machine: {
        environment: 'Entorno',
