...
export const ca: TranslationStructure = {
    ...
    settingsMods: {
        ...
        mod07Description: 'Mostra un botó «Obre el fitxer» a les crides de l\'eina Read. El botó utilitza el visor de fitxers integrat de Joy, que descarrega des de l\'host de Claude — funciona tant si l\'app i Claude són a la mateixa màquina com si no.',
    },
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor Joy vàlid',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de Joy copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Joy',
        happySessionId: 'ID de la sessió de Joy',
