...
export const ca: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        setupFooter: 'Al tauler d’ElevenLabs l’agent necessita: overrides activats per al system prompt i el primer missatge (pestanya Security); eines de client sendMessageToSession(sessionId, message) i processPermissionRequest(requestId, decision); opcionalment l’eina integrada skip_turn.',
    },
    machine: {
        environment: 'Entorn',
