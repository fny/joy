...
export const it: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        setupFooter: 'Nella dashboard ElevenLabs l’agente richiede: override abilitati per system prompt e primo messaggio (scheda Security); strumenti client sendMessageToSession(sessionId, message) e processPermissionRequest(requestId, decision); facoltativamente lo strumento integrato skip_turn.',
    },
    machine: {
