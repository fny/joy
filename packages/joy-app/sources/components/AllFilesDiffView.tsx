...
export const AllFilesDiffView = React.memo(function AllFilesDiffView({
    ...
    // session's diffs under paths that happen to match (Astra on 49b0c6c1, #91).
    ...
    // (Astra on e8973013, #91). Only the latest request for a path commits.
    ...
    // result would commit under the new one (Astra on ea4ce330). Retire
    ...
    React.useEffect(() => {
        ...
        // 90874d21, #91). Retiring the generation makes that completion a no-op.
        ...
        // cancelled unrelated in-flight work and looped (Astra on ba37b2b9,
