...
- **Chat history**: a message that could not be decrypted is kept as a gap and read again once the session key is corrected, instead of being skipped for good.
