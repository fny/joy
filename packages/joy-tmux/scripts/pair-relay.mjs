// Programmatic pairing of a joy-tmux daemon against a relay's happy-server.
...
// Usage: node scripts/pair-relay.mjs <relayUrl> <credsDir>   (run from packages/joy-tmux)
...
// ── 5. write joy-tmux credential files ──
