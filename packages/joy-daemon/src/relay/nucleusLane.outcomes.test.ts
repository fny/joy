...
describe("nucleusLane: adapter turn outcome (#584)", () => {
    ...
    // #584 residual (Astra on 81386fd0): the adapter fails while /start is
...
describe("nucleusLane: spawn-failed report acknowledged before abandoning (#581)", () => {
    ...
    // #581 residual (Astra on 81386fd0): the relay answers 200 with
    ...
    // #581 residual (Astra on e63be78b): the check was `applied === false`,
