...
// ── settlement fence: the current-owner rule (review 05bf2445) ──
...
// ── review 75e30a4f: command ids are global; a second session cannot claim one ──
...
test("acceptCommand refuses a relay turn another session's row carries (RelayTurnConflictError) under any caller id; a seq receipt naming another session's command is refused too (review 85abc7d8)", () => {
