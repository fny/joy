...
// belongs to another session (review 75e30a4f — session b used to receive
...
test("a relay turn session a's row carries is refused for session b under a DIFFERENT command id (RelayTurnConflictError): b owns nothing, a's row is untouched, b's facade never sees a's id (review 85abc7d8)", async () => {
