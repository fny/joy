...
// 37f1ca73); neither does insertion order (review 32f6ed84: a receipt from a
...
describe("transcript-uuid receipts are bounded (#560)", () => {
  ...
  it("a NEWER cursor pending behind unacked output never lets the cap reach past the committed one (review 37f1ca73)", () => {
  ...
  it("insertion order proves nothing: an older receipt for an entry beyond the committed offset survives a partial recovery's cursor (review 32f6ed84)", () => {
