// #560 through a real Claude Session (review 37f1ca73): an answer forwarded
...
// ── review 32f6ed84: insertion order proves nothing about byte coverage after
...
test("#560 (review 32f6ed84): a partial recovery's checkpoint never covers a receipt the tailer observed beyond its committed byte — the answer is emitted exactly once", async () => {
...
test("#560 (review 32f6ed84): a receipt from before positions were recorded is retained through the partial recovery and placed by the replay", async () => {
