...
const {root,codex,opencode,sleep,until}=await import('./wave2d-astra-helpers.mts');
...
// A TUI turn that wins the race is not proof that our pending item was admitted.
{
 ...
 assert.deepEqual(interrupts,[]);console.log('Codex unrelated TUI turn survives tombstone and busy rejection');
}
