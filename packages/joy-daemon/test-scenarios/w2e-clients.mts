...
const root=process.env.JOY_REVIEW_SRC ?? '/tmp/joy-test-tmux/review3/wave2e-queue-astra-checkout/packages/joy-daemon/src';
...
new901({approved:true});await sleep(50);assert.equal(observed901,false);
console.log('old external-resolution marker survives reconnect and suppresses legitimate new request with reused id');
