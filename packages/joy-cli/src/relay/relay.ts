...
export class RelayClient {
   ...
   *
   * The point of doing this from joy-cli is purely a UX guarantee:
   ...
   * `~/foo`. joy-cli always knows its homedir, so we can guarantee
   * the field is set.
   *
...
export async function createRelaySession(
  ...
  // Absent → the app treats a joy-cli session as claude.
...
// joy-cli downtime are delivered on next startup, not silently skipped.
