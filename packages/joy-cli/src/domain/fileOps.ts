// File/shell operation handlers exposed to the app for joy-cli sessions.
//
...
// joy-cli sessions as they do against happy-cli sessions. Request/response
...
// binaries are platform-specific and live next to joy-cli in the monorepo.
...
export async function handleBash(workingDirectory: string, data: BashRequest): Promise<BashResponse> {
  ...
  try {
    const options: ExecOptions = {
      ...
      // implicitly (its process cwd IS the session dir); joy-cli's daemon
