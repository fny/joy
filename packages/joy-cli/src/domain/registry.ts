...
// claude spawn + relay attach), recovering them after a joy-cli restart,
...
/**
 * Expand a leading ~ to the joy-cli user's home directory. tmux's -c flag
...
export class SessionRegistry {
  ...
  async create(opts: CreateSessionOpts): Promise<AgentSession> {
    ...
    // YOLO mode is the default for joy-cli sessions — the app drives the
  ...
  // ── Recovery (joy-cli restart with live tmux windows) ──────────────────────
