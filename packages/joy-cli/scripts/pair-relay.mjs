// Programmatic pairing of a joy-cli daemon against a relay's happy-server.
...
// Usage: node scripts/pair-relay.mjs <relayUrl> <credsDir>   (run from packages/joy-cli)
...
// ── 5. write joy-cli credential files ──
