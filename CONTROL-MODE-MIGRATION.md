...
- **Phase 0 — DONE** (`82392743`). `TmuxDriver` seam, spawn impl, `session.ts` routed.
  No behavior change.
- **Phase 1 — DONE + verified flag-on** (`bc506b82` client, `95fa0a66` driver+pump,
  `dac87ee8` hook):
...
- **Phases 2-4 — DONE** (`77424cc2` port, `39104d8c` hardening). Every steady-state tmux
