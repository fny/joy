...
- **[joy-daemon](packages/joy-daemon)** - the daemon + `joy` CLI. Runs Claude Code sessions
...
The `joy-daemon` daemon launches `claude` inside a tmux window and manages it for you —
