...
- Local acceptance is durable and transactional: `send`, `queueAdd`, relay
  ...
  occurrence id to dedupe (#560, review 37f1ca73); a write from a
  ...
  (review 05bf2445). Command ids are global and owned: `acceptCommand`
  ...
  treats another session's command id as unknown (review 75e30a4f).
