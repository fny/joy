...
| `joy-restart-session` | POST /sessions/:id/restart | Relaunch in place, carrying the CURRENT model, effort (`currentEffort` after a mid-session `/effort`, #51) and permission mode, and a user-locked `/title` (#474) |
